...
import { conflictError, notFoundError } from "#/core/result/error.factories";
import type { FireflyErrorCode } from "#/core/result/error.types";
import { FireflyErr } from "#/core/result/result.constructors";
