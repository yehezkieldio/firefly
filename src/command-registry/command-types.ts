 ...
 *
 * Defines the types for workflow commands. Commands are high-level operations
 * that compose multiple tasks and manage their lifecycle (setup, execution,
 * cleanup, error handling).
 *
 * @module command-registry/command-types
 */
...
import type { ResolvedServices, ServiceKey, ServiceKeys, ServiceKeysFromArray } from "#/services/service-registry";
