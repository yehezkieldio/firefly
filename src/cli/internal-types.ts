/**
 * Internal type definitions for the Firefly CLI.
 *
 * This module contains types used internally by the CLI implementation.
 * These types are not part of the public API and should not be imported
...
/**
 * Inferred type from {@link GlobalOptionsSchema}.
 */
