/**
 * Commander.js option builder for Zod schemas.
 *
 * This module provides utilities to automatically generate Commander.js CLI options
 * from Zod schemas, ensuring type safety and consistent option handling.
 *
 * @internal
 */
